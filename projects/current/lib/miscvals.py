...
RE_NT_SEQ = r'([acgt]{10,})'
RE_SQ_BRACKETS = r"(\[.*\])"
RE_HAS_CAS = r'<tr><td class="d1"><a href=information\.php\?word=C[0-9]* target="_blank">(C[0-9]*)<\/a><\/td>' \
...
TO_REMOVE = ['<tr>', '</tr>', '</font>', "\n", "\\n", ">", '</a>', '</td>', "target=\"_blank\">",
             "target=\"_blank\"", "<td class=\"d1\">", '<font color=#FF00BF>', '<a href=information.php?word=',
             '</a', "<td class=\"d1\"", "\"</td\"", "</td"]
