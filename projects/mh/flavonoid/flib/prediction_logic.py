...
def pich(e): return nca(e) and (E09 in e)  # pinocembrin chalcone || new compound of interest

def pino(e): return pich(e) and (E10 in e)  # pinocembrin || new compound of interest
...
def dgen(e): return nar(e) and (E21 in e)  # 2-Hydroxy-2,3-dihydrogenistein || new compound of interest

def hesp(e): return nar(e)  # hesperetin

def apif(e): return nar(e) and (or_in(e, E17_1, E17_FULL, E17_2))  # apiforol || new compound of interest
